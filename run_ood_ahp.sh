...
# python ood_ahp_eval.py --model_id llama2:13b --robustness_type ood --benchmark flipkart
python ood_ahp_eval.py --model_id llama2:13b --robustness_type ood2 --benchmark flipkart
python ood_ahp_eval.py --model_id llama2:13b --robustness_type ood --benchmark ddx
python ood_ahp_eval.py --model_id llama2:13b --robustness_type ood2 --benchmark ddx